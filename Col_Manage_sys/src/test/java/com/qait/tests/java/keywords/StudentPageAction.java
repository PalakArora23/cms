...
public class StudentPageAction 

{
		...
		String stu_id;
		int score;
		public StudentPageAction() {
			this(" ", " ", 0);
		}
		public StudentPageAction(String initName, String initId, int initScore) {
			name = initName;
			stu_id = initId;
			score = initScore;
		}
		...
		public static void main(String[] args) {
			...
			StudentPageAction stu = new StudentPageAction();
			StudentPageAction max = new StudentPageAction();
			StudentPageAction min = new StudentPageAction(" ", " ", 100);
			for (int i = 0; i < n; i ++) {
				stu.name = in.next();
				stu.stu_id = in.next();
